...
public class SpiderDeathAnimation : MonoBehaviour
{
    ...
    [SerializeField]
    private float scoreHangTime = 1f;

    private Sprite[][] sprites;
    [Header("Spider Death Sprites")]
    [SerializeField]
    ...
    [Header("Spider Score Sprites")]
    [SerializeField]
    private Sprite[] color1ScoreSprites;
    [SerializeField]
    private Sprite[] color2ScoreSprites;
    [SerializeField]
    private Sprite[] color3ScoreSprites;
    [SerializeField]
    private Sprite[] color4ScoreSprites;
    [SerializeField]
    private Sprite[] color5ScoreSprites;
    [SerializeField]
    private Sprite[] color6ScoreSprites;
    [SerializeField]
    private Sprite[] color7ScoreSprites;
    [SerializeField]
    private Sprite[] color8ScoreSprites;
    [SerializeField]
    private Sprite[] color9ScoreSprites;
    [SerializeField]
    private Sprite[] color10ScoreSprites;
    [SerializeField]
    private Sprite[] color11ScoreSprites;
    [SerializeField]
    private Sprite[] color12ScoreSprites;
    [SerializeField]
    private Sprite[] color13ScoreSprites;
    [SerializeField]
    private Sprite[] color14ScoreSprites;

    bool scoreShown = false;

    [HideInInspector]
    public int scoreTypeEarned = 0;
    ...
    private void Awake()
    {
        ...
        scoreSprites = new Sprite[14][];
        scoreSprites[0] = color1ScoreSprites;
        scoreSprites[1] = color2ScoreSprites;
        scoreSprites[2] = color3ScoreSprites;
        scoreSprites[3] = color4ScoreSprites;
        scoreSprites[4] = color5ScoreSprites;
        scoreSprites[5] = color6ScoreSprites;
        scoreSprites[6] = color7ScoreSprites;
        scoreSprites[7] = color8ScoreSprites;
        scoreSprites[8] = color9ScoreSprites;
        scoreSprites[9] = color10ScoreSprites;
        scoreSprites[10] = color11ScoreSprites;
        scoreSprites[11] = color12ScoreSprites;
        scoreSprites[12] = color13ScoreSprites;
        scoreSprites[13] = color14ScoreSprites;
    }
